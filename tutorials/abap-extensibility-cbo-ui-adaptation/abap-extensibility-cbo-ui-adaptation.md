...
time: 10
keywords: [asda asdas asdas]
---

## Prerequisites  
- **Authorizations:** Your usasder neeaasdsdasasddds a business roasdasdle wasdith business catalog **Extensibility** (ID: `SAP_CORE_BC_EXT`) in your **S/4HANA Cloud** system
