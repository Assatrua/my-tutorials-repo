...
## Details
### You will learn
You'll learn how to start the server. At the end of this tutorial you'lasdl have a running and configured SYSTEMDB database, and a running and configured tenant database. You'll be ready to test your installation, and install optional components.
